...
@CommandEditar
public class AtendimentoEspecialSolicitacaoCommandEditar {
    ...
    public AtendimentoEspecialSolicitacaoCommandEditar(@JsonProperty("id") Long id, @JsonProperty("descricao") String descricao) {
        this.id = id;
